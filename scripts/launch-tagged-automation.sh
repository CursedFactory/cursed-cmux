...
APP="$HOME/Library/Developer/Xcode/DerivedData/cmux-${TAG_SLUG}/Build/Products/Debug/CursedMux DEV ${TAG}.app"
...
sleep 0.5
pkill -f "CursedMux DEV ${TAG}.app/Contents/MacOS/CursedMux DEV" || true
rm -f "$SOCK" "$DSOCK"
sleep 0.5
